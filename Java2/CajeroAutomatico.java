...
public class CajeroAutomatico {
    public static void main(String[]  args){
        ...
        int opcion; // Variable para alamacenar la opción del menú 

        //Repetir el menú mientras la opción no sea salir (4)
        do {
            // Mostrar menu de opcines 
            ...
            opcion = scanner.nextInt(); // Leer la opción elegida por la usuario 
            ...
            case 3 -> {
                ...
                if (retiro <=0){
                    // Validación: el monto debe ser mayor a cero 
                    System.out.println("El monto debe ser mayor a 0."); 
                    continue; // Volver el menú sin hacer nada 
